...
# ######################################################################
python main.py -in ./videos/hall_qcif_bw.yuv -out ./videos/q3_r1_hall.yuv -y_res 144 -x_res 176 -frames 10 -o both -q 3 -i 2 -n 3 -r 4 &

python main.py -in ./videos/hall_qcif_bw.yuv -out ./videos/q3_r4_hall.yuv -y_res 144 -x_res 176 -frames 10 -o both -q 3 -i 8 -n 3 -r 4 &

python main.py -in ./videos/hall_qcif_bw.yuv -out ./videos/q3_r8_hal.yuv -y_res 144 -x_res 176 -frames 10 -o both -q 3 -i 64 -n 3 -r 4 &

# ######################################################################
# Generating for various r values (Q3) - Hall
# ######################################################################
# python main.py -in ./videos/hall_qcif_bw.yuv -out ./videos/q3_r1_hall.yuv -y_res 144 -x_res 176 -frames 10 -o both -q 3 -i 8 -n 3 -r 1 &

# python main.py -in ./videos/hall_qcif_bw.yuv -out ./videos/q3_r4_hall.yuv -y_res 144 -x_res 176 -frames 10 -o both -q 3 -i 8 -n 3 -r 4 &

# python main.py -in ./videos/hall_qcif_bw.yuv -out ./videos/q3_r8_hall.yuv -y_res 144 -x_res 176 -frames 10 -o both -q 3 -i 8 -n 3 -r 8 &


# ######################################################################
# Generating for various n values (Q3) - Hall
# ######################################################################
# python main.py -in ./videos/hall_qcif_bw.yuv -out ./videos/q3_n1_hall.yuv -y_res 144 -x_res 176 -frames 10 -o both -q 3 -i 8 -n 1 -r 4 &

# python main.py -in ./videos/hall_qcif_bw.yuv -out ./videos/q3_n2_hall.yuv -y_res 144 -x_res 176 -frames 10 -o both -q 3 -i 8 -n 2 -r 4 &

# python main.py -in ./videos/hall_qcif_bw.yuv -out ./videos/q3_n3_hall.yuv -y_res 144 -x_res 176 -frames 10 -o both -q 3 -i 8 -n 3 -r 4 &